...
samplerate = 44100.0
with AudioFile('453384__loudernoises__clean-strumming-arpeggio.wav').resampled_to(samplerate) as f:
...
for i, result in enumerate(results):
    with AudioFile(f'processed-output_{i}.wav', 'w', samplerate, result.shape[0]) as f:
        f.write(result)
